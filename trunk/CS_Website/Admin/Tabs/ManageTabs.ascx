...
<%@ Control AutoEventWireup="true" CodeFile="ManageTabs.ascx.cs" Explicit="True" Inherits="DotNetNuke.Modules.Admin.Tabs.ManageTabs" Language="C#" %>
...
<p>
    ...
    <asp:LinkButton ID="cmdGoogle" runat="server" CssClass="CommandButton" OnClick="cmdGoogle_Click" resourcekey="SubmitToGoogle" Text="Submit Tab To Google"></asp:LinkButton>
</p>
