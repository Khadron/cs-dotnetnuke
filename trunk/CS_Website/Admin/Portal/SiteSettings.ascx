...
<%@ Control AutoEventWireup="true" CodeFile="SiteSettings.ascx.cs" Debug="False" EnableViewState="True" Explicit="True" Inherits="DotNetNuke.Modules.Admin.PortalManagement.SiteSettings"
    Language="C#" %>
<!-- Settings Tables -->
    ...
    <tr>
        <td valign="top" width="560">
            <asp:Panel ID="pnlSettings" runat="server" CssClass="WorkPanel" Visible="True">
                ...
                <table id="tblStylesheet" runat="server" border="0" cellpadding="2" cellspacing="0" summary="Stylesheet Editor Design Table" width="525">
                    <tr>
                        <td>
