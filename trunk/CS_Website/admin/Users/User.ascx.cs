...
namespace DotNetNuke.Modules.Admin.Users
{
    ...
    public partial class User : UserModuleBase
    {
        ...
        public event UserCreatedEventHandler UserCreated
        {
            add
            {
                UserCreatedEvent = (UserCreatedEventHandler)Delegate.Combine( UserCreatedEvent, value );
            }
            remove
            {
                UserCreatedEvent = (UserCreatedEventHandler)Delegate.Remove( UserCreatedEvent, value );
            }
        }
        ...
        public event UserCreatedEventHandler UserCreateCompleted
        {
            add
            {
                UserCreateCompletedEvent = (UserCreatedEventHandler)Delegate.Combine( UserCreateCompletedEvent, value );
            }
            remove
            {
                UserCreateCompletedEvent = (UserCreatedEventHandler)Delegate.Remove( UserCreateCompletedEvent, value );
            }
        }
        ...
        public event UserDeletedEventHandler UserDeleted
        {
            add
            {
                UserDeletedEvent = (UserDeletedEventHandler)Delegate.Combine( UserDeletedEvent, value );
            }
            remove
            {
                UserDeletedEvent = (UserDeletedEventHandler)Delegate.Remove( UserDeletedEvent, value );
            }
        }
        ...
        public event EventHandler UserUpdated
        {
            add
            {
                UserUpdatedEvent = (EventHandler)Delegate.Combine( UserUpdatedEvent, value );
            }
            remove
            {
                UserUpdatedEvent = (EventHandler)Delegate.Remove( UserUpdatedEvent, value );
            }
        }
        ...
        public event EventHandler UserUpdateCompleted
        {
            add
            {
                UserUpdateCompletedEvent = (EventHandler)Delegate.Combine( UserUpdateCompletedEvent, value );
            }
            remove
            {
                UserUpdateCompletedEvent = (EventHandler)Delegate.Remove( UserUpdateCompletedEvent, value );
            }
        }
