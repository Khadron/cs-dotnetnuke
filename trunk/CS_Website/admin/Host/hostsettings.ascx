						...
						<table id="tblPayment" cellspacing="2" cellpadding="2" summary="Appearance Design Table"
							...
							<tr>
								...
								<td align="left">
									...
									<asp:linkbutton id="cmdProcessor" cssclass="CommandButton" runat="server" resourcekey="ProcessorWebSite" enableviewstate="False">Go To Payment Processor Website</asp:linkbutton>
								</td>
							</tr>
							<tr>
					...
					<td valign="top" width="475">
                        ...
                        <table id="tblFriendlyUrl" runat="server" cellspacing="2" cellpadding="2" summary="Appearance Design Table" border="0">
	                        <tr>
		                        ...
		                        <td valign="top"><asp:checkbox id="chkUseFriendlyUrls" AutoPostBack="true" cssclass="NormalTextBox" runat="server"></asp:checkbox></td>
	                        </tr>
...
<table class="Settings" cellspacing="2" cellpadding="2" width="560" summary="Host Settings Design Table"
	...
	<tr>
		<td>
			...
			<asp:linkbutton id="cmdUpgrade" resourcekey="cmdGo" runat="server" cssclass="CommandButton">Go</asp:linkbutton>
		</td>
	</tr>
	<tr>
		<td>
