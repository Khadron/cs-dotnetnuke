...
<%@ Control Language="C#" AutoEventWireup="false" Explicit="True" Inherits="DotNetNuke.Modules.Admin.Skins.EditSkins" CodeFile="EditSkins.ascx.cs" %>
<center>
...
<asp:LinkButton id="cmdDelete" resourcekey="cmdDelete" Runat="server" CssClass="CommandButton">Delete Skin Package</asp:LinkButton></asp:panel></td>
		</tr>
		<tr>
			<td colSpan="4">&nbsp;</td>
		</tr>
