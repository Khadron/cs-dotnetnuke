            ...
            try
            {
                if( ! Page.IsPostBack )
                {
                    ...
                    else
                    {
                        ...
                        if( mode != "" && rbMode.Items.FindByValue( mode ) != null )
                        {
                ...
                else
                {
                    try
                    {
                        if( File.Exists( ResourceFile( cboLocales.SelectedValue, rbMode.SelectedValue ) ) )
                        {
                            ...
                            UI.Skins.Skin.AddModuleMessage( this, string.Format( Localization.GetString( "Deleted", this.LocalResourceFile ), ResourceFile( cboLocales.SelectedValue, rbMode.SelectedValue ), null ), ModuleMessage.ModuleMessageType.GreenSuccess );
