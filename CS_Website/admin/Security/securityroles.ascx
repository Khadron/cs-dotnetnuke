				...
				<table cellspacing="4" cellpadding="0" summary="Security Roles Design Table" border="0">
					...
					<tr>
						<td valign="top" width="160">
							...
							<asp:dropdownlist id="cboUsers" cssclass="NormalTextBox" runat="server" autopostback="True" datavaluefield="UserID" datatextfield="FullName" width="160"></asp:dropdownlist>
