		...
		<tr>
			...
			<td width=325>
				<asp:textbox id=txtRSVPCode cssclass="NormalTextBox" runat="server" maxlength="50" columns="30" width="100"></asp:textbox>
          		<asp:linkbutton class="CommandButton" id="cmdRSVP" runat="server" resourcekey="cmdRSVP" text="Subscribe"></asp:linkbutton>
			</td>
		</tr>
		<tr>
			<td colspan="2">
...
<p>
	...
	<asp:linkbutton class="CommandButton" id="cmdCancel" resourcekey="cmdCancel" runat="server" causesvalidation="False" text="Cancel" borderstyle="none"></asp:linkbutton>&nbsp;&nbsp;
	<asp:linkbutton class="CommandButton" id="cmdUnregister" resourcekey="cmdUnregister" runat="server" text="Unregister"></asp:linkbutton>
</p>
