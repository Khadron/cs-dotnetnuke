<%@ Control Language="C#" AutoEventWireup="true" Explicit="True" Inherits="DotNetNuke.UI.ControlPanels.IconBar" CodeFile="IconBar.ascx.cs" %>
								...
								<td align="center">
									<table cellspacing="1" cellpadding="0" border="0" height="100%">
										<tr valign="bottom">
											...
											<td align="center" nowrap><asp:LinkButton id="cmdAddModuleIcon" runat="server" cssclass="CommandButton" CausesValidation="False" OnClick="AddModule_Click">
