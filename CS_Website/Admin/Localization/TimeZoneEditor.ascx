	...
	<TABLE id="Table1" cellSpacing="1" cellPadding="1" border="0">
		<TR>
			...
			<TD valign="top"><asp:DropDownList id="cboLocales" runat="server" Width="300px" DataTextField="name" DataValueField="key"
					AutoPostBack="True" OnSelectedIndexChanged="cboLocales_SelectedIndexChanged"></asp:DropDownList></TD>
		</TR>
	</TABLE>
</P>
<P>
	<asp:Panel id="pnlMissing" runat="server" Visible="False" Wrap="True">
		...
		<asp:LinkButton id="cmdAddMissing" runat="server" resourcekey="cmdAddMissing" CssClass="CommandButton"
			CausesValidation="false" OnClick="cmdAddMissing_Click">Add Missing Entries</asp:LinkButton>
	</asp:Panel>
</P>
<P>
...
<P>
	<asp:LinkButton id="cmdUpdate" runat="server" CssClass="CommandButton" resourcekey="cmdUpdate" OnClick="cmdUpdate_Click">Update</asp:LinkButton>
	<asp:LinkButton id="cmdCancel" runat="server" CssClass="CommandButton" resourcekey="cmdCancel" CausesValidation="false" OnClick="cmdCancel_Click">Cancel</asp:LinkButton>
</P>
